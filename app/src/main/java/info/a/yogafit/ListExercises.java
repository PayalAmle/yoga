...
import info.a.yogafit.Adapter.RecyclerViewAdapter;
...
public class ListExercises extends AppCompatActivity {
    ...
    private void initData() {
        ...
        exerciseList.add(new Exercise(R.drawable.half_pigeon,"Half Pigeon Pose"));
        ...
        exerciseList.add(new Exercise(R.drawable.crescent_lunge,"Crescent Pose"));
